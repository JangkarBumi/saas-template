  ...
  return (
    <nav className="bg-gray-900 sm:flex sm:justify-between sm:px-4 sm:py-3 sm:items-center">
      ...
      >
        <a
          href="/about"
          className="block px-2 py-1 text-white font-semibold rounded hover:bg-gray-800 sm:mt-0"
        >
          About
        </a>
        <a
          href="/contact-us"
          className="mt-1 block px-2 py-1 text-white font-semibold reounded hover:bg-gray-800 sm:mt-0 sm:ml-2"
        >
          Contact Us
        </a>
        <a
